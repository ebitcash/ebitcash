...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the eBitcashTestFramework
    pass

class ExampleTest(eBitcashTestFramework):
    # Each functional test is a subclass of the eBitcashTestFramework class.
    ...
    def custom_method(self):
        ...
        eBitcashTestFramework class so other tests can use it."""
