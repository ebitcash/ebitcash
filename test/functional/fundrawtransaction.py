...
class RawTransactionsTest(eBitcashTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid ebitcash address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        ebitcashd_processes[1].wait(timeout=EBITCASHD_PROC_WAIT_TIMEOUT)
