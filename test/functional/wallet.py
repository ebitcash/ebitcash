...
class WalletTest(eBitcashTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 EBC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 ebc in block rewards plus fees, but
        ...
        # Send 10 EBC with subtract fee from amount
        ...
        # Sendmany 10 EBC with subtract fee from amount
