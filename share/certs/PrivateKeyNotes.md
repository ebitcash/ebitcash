...
unlocked to sign the eBitcash-Qt.app bundle.
...
allowing somebody to distribute a eBitcash-Qt.app or ebitcash-qt-setup.exe with a valid
...
that the ebitcash-qt.exe file inside the installer had not been tampered with.
