...
Then, to tunnel a SSL connection on 29222 to a RPC server bound on localhost on port 19222 do:

    stunnel -d 29222 -r 127.0.0.1:19222 -p stunnel.pem -P ''
...
- #7209 `f3ad812` test: don't override EBITCASHD and EBITCASHCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add EBITCASHD_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
...
- #6504 `b6fee6b` Rationalize currency unit to "EBTC" (Ross Nicoll)
