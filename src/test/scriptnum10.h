...
#ifndef EBITCASH_TEST_SCRIPTNUM10_H
#define EBITCASH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from eBitcash Core 0.10.0, for cross-comparison.
 */
public:
