...
#ifndef EBITCASH_WALLET_WALLET_H
#define EBITCASH_WALLET_WALLET_H
...
public:
     ...
     * on this ebitcash node, and set to 0 for transactions that were created
...
#endif // EBITCASH_WALLET_WALLET_H
