...
#if defined(NDEBUG)
# error "eBitcash cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "eBitcash Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s EBTC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("ebitcash-scriptch");
