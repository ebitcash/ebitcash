...
#ifndef EBITCASH_QT_EBITCASHUNITS_H
#define EBITCASH_QT_EBITCASHUNITS_H
...
/** eBitcash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class eBitcashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit eBitcashUnits(QObject *parent);

    /** eBitcash units.
      @note Source: https://en.ebitcash.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        EBC,
...
typedef eBitcashUnits::Unit eBitcashUnit;

#endif // EBITCASH_QT_EBITCASHUNITS_H
