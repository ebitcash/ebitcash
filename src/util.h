 ...
 */
#ifndef EBITCASH_UTIL_H
#define EBITCASH_UTIL_H
...
extern const char * const EBITCASH_CONF_FILENAME;
extern const char * const EBITCASH_PID_FILENAME;
...
{
    std::string s = strprintf("ebitcash-%s", name);
